        ...
        <div className="min-h-screen bg-[var(--bg)] flex flex-col justify-center items-center p-6 font-sans">
            ...
            <div className="w-full max-w-[400px]">
                <div className="mb-10 text-center">
                    ...
                    <p className="text-[var(--text)] font-semibold text-lg mt-3">
                    ...
                    <form onSubmit={handleSignup} className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                {password && (
                                    <span
                                        className={`text-xs ${passwordStrength === 'Weak' ? 'text-orange-500' : passwordStrength === 'Strong' ? 'text-green-500' : 'text-yellow-500'}`}
                                    >
                                        {passwordStrength}
                                    </span>
                                )}
