...
export interface FlashcardDeck {
    ...
    source_type?: 'session' | 'topic' | 'vault' | 'manual' | 'shared';
    source_session_id?: string | null;
    source_topic?: string | null;
    source_concept_ids?: string[] | null;
    total_cards: number;
    cards_know_it: number;
    cards_still_learning: number;
    cards_not_studied: number;
    is_public: boolean;
...
export interface Flashcard {
    ...
    card_type?: 'definition' | 'mechanism' | 'example' | 'distinction';
    is_starred: boolean;
    progress_state: 'not_studied' | 'still_learning' | 'know_it';
    times_seen: number;
...
export interface FlashcardStudySession {
    ...
    deck_id: string;
    user_id: string;
    mode: 'flip' | 'learn' | 'write' | 'rapid_fire';
