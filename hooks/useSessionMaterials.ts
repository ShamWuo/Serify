...
export interface SessionMaterialsSummary {
  flashcards: { exists: boolean; cardCount?: number; generatedAt?: string; progress?: any; generationCount?: number };
  practiceQuiz: { exists: boolean; questionCount?: number; generatedAt?: string; attempts?: any; generationCount?: number };
  deepDive: { exists: boolean; conceptName?: string; generatedAt?: string; readAt?: string; generationCount?: number };
